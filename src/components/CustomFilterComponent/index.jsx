    ...
    <div className="w-64 p-4 bg-primary shadow-md rounded-sm ">
      {filters.map((filter, index) => (
        <div key={index} className="mb-4 border-b pb-2">
          <div
            className="flex justify-between items-center cursor-pointer text-heading text-opacity-100 hover:text-opacity-50"
              ...
              {filter.type === "rating" &&
                filter.options.map((rating, i) => (
                  ...
                  >
                    ...
                    <span className="text-heading">({rating} Star)</span>
                  </label>
                ))}
              ...
              {filter.type === "range" && (
                <div className="mt-2">
                  ...
                  <div className="flex justify-between text-sm text-secondary">
                    <span className="bg-mainText text-white px-2 py-1 rounded">
                      ${filter.min}
                    </span>
                    <span className="bg-mainText text-white px-2 py-1 rounded">
