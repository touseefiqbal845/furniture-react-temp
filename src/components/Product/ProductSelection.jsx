...
const ProductSelection = () => {
  ...
  return (
    <div className="p-6  rounded-lg max-w-sm mx-auto bg-secondary shadow-sm text-center">
      <p className="text-heading font-semibold ">Colour:</p>
      ...
      <div className="flex items-center justify-center mt-4 space-x-4">
        <button
          className="p-2 border bg-white rounded-md hover:opacity-500 text-"
        ...
        <button
          className="p-2 border bg-white rounded-md hover:bg-gray-300"
      ...
      <div className="text-center mt-2 text-white text-sm flex justify-center items-center space-x-2">
