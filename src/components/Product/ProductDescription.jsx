...
export default function ProductDescription() {
  ...
  return (
    <div className="p-4 max-w-lg mx-auto bg-secondary rounded-lg">
      <p className="text-small text-heading font-secondary">
      ...
      <div className="flex items-center text-yellow-500 text-small space-x-1">
        ...
        <FaRegStar />
        <a href="#" className="text-gray-400 text-small underline ml-2">
          20 Reviews
        </a>
      </div>
      <p className="text-paragraph  mt-1">
        MRP:{" "}
        <span className="text-small text-mainText font-semibold">$15.00</span>
      </p>
      ...
      >
        ...
        <ul className="list-disc  text-heading grid gap-2">
