    ...
    <div className="">
      <div className="flex">
        ...
        <div className="flex-1 p-4">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-100 rounded-lg bg-secondary">
          ...
          <div
            className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 ${gridColumns} gap-6 mt-8`}
          >
